...
function FormularioCadastro({onSubmitForm, validateCPF, maskCpf, maskCep}) {
  ...
  const formularios = [
    ...
    <DadosPessoais onSubmitForm={DataCollection} validateCPF={validateCPF} maskCpf={maskCpf} />,
    <DadosEndereco maskCep={maskCep} onSubmitForm={DataCollection} />,
